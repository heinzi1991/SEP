...
public:
	...
	// @return int
	//
	int makeMoveInDirection(std::string direction);
	...
	//--------------------------------------------------------------------------
	// Game::checkFastMoveInput(std::string input) method
	//
	// @param std::string input
	// @return bool
	//
	bool checkFastMoveInput(std::string input);
	
	//--------------------------------------------------------------------------
	// Game:: checkCommandSaveInput(std::string fileName) method
	//
	// @param std::string fileName
	// @return bool
	//
	bool checkCommandSaveInput(std::string fileName);
